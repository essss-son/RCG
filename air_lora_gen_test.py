...
import json
import pdb
from peft import PeftModel, peft_model
import os
...
def generate_multi(args):
    output_path = './lora_test/'
    os.makedirs(output_path, exist_ok=True)
    f = open(output_path + str(args.length)+"Air_lora_sentiment.jsonl", 'a')
            ...
            with torch.no_grad():
                ...
                while cur_len < max_length:
                    if past_key_values is None:
                        dic_base = model['base_model'](input_ids=input_text, return_dict=True, use_cache=True)
                        ...
                        for item in args.att_type:
                            ...
                            att_dic[item] = dict()
                            att_dic[item]['dict'] = model[item](input_ids=input_text, return_dict=True, use_cache=True)
                        ...
                        dic_base = model['base_model'](input_ids=prev, past_key_values=past_key_values, return_dict=True,
                                         use_cache=True)
                        logits_base, past_key_values = dic_base.logits[:, -1, :], dic_base.past_key_values
                        ...
                        for item in args.att_type:
                            ...
                            att_dic[item]['dict'] = model[item](input_ids=prev, past_key_values=att_dic[item]['past_kv'],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt_sent", default='/home/anke/DXZ/freectrl/version_9/data/prompt_sent.jsonl', type=str,
    ...
    base_model = GPT2LMHeadModel.from_pretrained(
        '/home/anke/DXZ/models/gpt2-medium')
    pos_model = GPT2LMHeadModel.from_pretrained(
        '/home/anke/DXZ/models/gpt2-medium')
    neg_model = GPT2LMHeadModel.from_pretrained(
        '/home/anke/DXZ/models/gpt2-medium')
    pos_lora_path = "/home/anke/DXZ/freectrl/version_9/lora_train/lora_ckpt/c_attn_lora/pos_lora_acc0.703"
    neg_lora_path = "/home/anke/DXZ/freectrl/version_9/lora_train/lora_ckpt/c_attn_lora/neg_lora_acc0.75"
    model_dict = {
        'base_model': base_model.to(args.device),
        '0':PeftModel.from_pretrained(pos_model,pos_lora_path).to(args.device),
        '1':PeftModel.from_pretrained(neg_model,neg_lora_path).to(args.device)
    }
    args.model = model_dict

    args.tokenizer = GPT2Tokenizer.from_pretrained('/home/anke/DXZ/models/gpt2-medium')
